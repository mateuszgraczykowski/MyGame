...
public class UI extends MouseAdapter {
	...
	public void mousePressed(MouseEvent e) {
		...
		if(Main.gameStatus==Status.Help) {
	...
	public void render(Graphics g) {
		...
		if(Main.gameStatus==Status.Menu || Main.gameStatus==Status.Help) {
			...
			if(Main.gameStatus==Status.Help) {				
				...
				g.drawString("Use WASD to move, LMB to fire and RMB to set a trap.", 50, 400);
